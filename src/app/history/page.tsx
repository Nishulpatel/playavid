...
export default function HistoryPage() {
  ...
  const videos = all.filter((v) => history.includes(v.id))
  ...
  return (
    <AppShell>
      ...
      {videos.length === 0 ? (
        <div className="rounded-lg border p-8 text-center text-muted-foreground">You have not watched any videos yet.</div>
      ) : (
